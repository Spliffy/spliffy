...
public class ShareManager {
    ...
    public void sendShareInvites(User curUser, Repository repo, String shareWith, AccessControlledResource.Priviledge priv, String message) {
    ...
    private List<StandardMessage> createShares(User curUser, Repository repo, String shareWith, AccessControlledResource.Priviledge p, String message, Session session) {
     ...
     * @throws Exception 
     */
    public void acceptShare(User curUser, Share share, String entityName, String sharedAsName) throws Exception{
        
        Session session = SessionManager.session();
        Transaction tx = session.beginTransaction();
        BaseEntity sharedTo = BaseEntity.get(entityName, session);
