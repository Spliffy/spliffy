...
create table branch (id number(19,0) not null, name varchar2(255 char) not null, head number(19,0), linked_to number(19,0), repository number(19,0) not null, primary key (id));
create table cal_event (id number(19,0) not null, name varchar2(255 char) not null, description varchar2(255 char), timezone varchar2(255 char), ctag number(19,0) not null, start_date timestamp not null, end_date timestamp not null, summary varchar2(255 char), created_date timestamp not null, modified_date timestamp not null, calendar number(19,0) not null, primary key (id));
create table calendar (id number(19,0) not null, name varchar2(255 char) not null, ctag number(19,0) not null, color varchar2(255 char), created_date timestamp not null, modified_date timestamp not null, owner varchar2(255 char) not null, primary key (id), unique (name, owner));
create table commit_item (id number(19,0) not null, created_date timestamp, editor varchar2(255 char), root_item_version number(19,0) not null, branch number(19,0) not null, primary key (id));
create table contact (id number(19,0) not null, name varchar2(255 char) not null, given_name varchar2(255 char), sur_name varchar2(255 char), mail varchar2(255 char), uid varchar2(255 char) not null, created_date timestamp not null, modified_date timestamp not null, organization_name varchar2(255 char), telephonenumber varchar2(255 char), address_book number(19,0) not null, primary key (id));
create table deleted_item (id number(19,0) not null, deleted_resource number(19,0), deleted_from number(19,0), repo_version number(19,0), primary key (id));
create table directory_member (id number(19,0) not null, name varchar2(1000 char), member_item number(19,0) not null, parent_item number(19,0) not null, primary key (id), unique (name, parent_item));
...
create table item_version (id number(19,0) not null, item_hash number(19,0) not null, modified_date date not null, item number(19,0) not null, primary key (id));
...
create table repository (id number(19,0) not null, name varchar2(255 char), created_date date not null, head number(19,0), base_entity varchar2(255 char) not null, primary key (id));
...
create table user_entity (name varchar2(255 char) not null, password varchar2(255 char), email varchar2(255 char) not null, primary key (name));
create table volume (id number(19,0) not null, used_bytes number(19,0) not null, target_capacity number(19,0) not null, primary key (id));
create table volume_instance (id number(19,0) not null, location varchar2(255 char) not null, capacity number(19,0), cost number(10,0) not null, online number(1,0) not null, lost number(1,0) not null, instance_type varchar2(255 char) not null, volume number(19,0), primary key (id), unique (location, instance_type));
