...
create table commit_item (id number(19,0) not null, created_date timestamp, editor varchar2(255 char), branch number(19,0) not null, root_item_version number(19,0) not null, primary key (id));
