...
create table branch (id number(19,0) not null, name varchar2(255 char) not null, linked_to number(19,0), repository number(19,0) not null, head number(19,0), primary key (id));
...
create table permission (id number(19,0) not null, priviledge number(10,0), granted_on number(19,0), grantee varchar2(255 char), primary key (id));
