...
create table branch (id number(19,0) not null, name varchar2(255 char) not null, linked_to number(19,0), head number(19,0), repository number(19,0) not null, primary key (id));
...
create table commit_item (id number(19,0) not null, created_date timestamp, branch number(19,0) not null, root_item_version number(19,0) not null, editor varchar2(255 char), primary key (id));
