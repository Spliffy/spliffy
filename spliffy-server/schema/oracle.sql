...
create table branch (id number(19,0) not null, name varchar2(255 char) not null, repository number(19,0) not null, linked_to number(19,0), head number(19,0), primary key (id));
