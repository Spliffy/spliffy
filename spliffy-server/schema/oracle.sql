...
create table branch (id number(19,0) not null, name varchar2(255 char) not null, head number(19,0), repository number(19,0) not null, linked_to number(19,0), primary key (id));
...
create table deleted_item (id number(19,0) not null, repo_version number(19,0), deleted_from number(19,0), deleted_resource number(19,0), primary key (id));
