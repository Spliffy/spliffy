...
create table branch (id bigint generated by default as identity (start with 1), name varchar(255) not null, repository bigint not null, head bigint, linked_to bigint, primary key (id));
