...
create table branch (id bigint generated by default as identity (start with 1), name varchar(255) not null, linked_to bigint, head bigint, repository bigint not null, primary key (id));
...
create table commit_item (id bigint generated by default as identity (start with 1), created_date timestamp, branch bigint not null, root_item_version bigint not null, editor varchar(255), primary key (id));
