...
create table deleted_item (id bigint generated by default as identity (start with 1), repo_version bigint, deleted_resource bigint, deleted_from bigint, primary key (id));
...
create table repository (id bigint generated by default as identity (start with 1), name varchar(255), created_date date not null, base_entity varchar(255) not null, head bigint, primary key (id));
