...
create table branch (id bigint generated by default as identity (start with 1), name varchar(255) not null, linked_to bigint, repository bigint not null, head bigint, primary key (id));
...
create table deleted_item (id bigint generated by default as identity (start with 1), deleted_from bigint, deleted_resource bigint, repo_version bigint, primary key (id));
