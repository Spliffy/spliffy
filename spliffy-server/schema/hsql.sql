...
create table branch (id bigint generated by default as identity (start with 1), name varchar(255) not null, repository bigint not null, linked_to bigint, head bigint, primary key (id));
...
create table commit_item (id bigint generated by default as identity (start with 1), created_date timestamp, root_item_version bigint not null, editor varchar(255), branch bigint not null, primary key (id));
