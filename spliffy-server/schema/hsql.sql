...
create table deleted_item (id bigint generated by default as identity (start with 1), deleted_from bigint, repo_version bigint, deleted_resource bigint, primary key (id));
