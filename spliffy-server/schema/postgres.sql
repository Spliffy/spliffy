...
create table branch (id int8 not null, name varchar(255) not null, linked_to int8, repository int8 not null, head int8, primary key (id));
...
create table deleted_item (id int8 not null, deleted_from int8, deleted_resource int8, repo_version int8, primary key (id));
