...
create table deleted_item (id int8 not null, repo_version int8, deleted_resource int8, deleted_from int8, primary key (id));
...
create table repository (id int8 not null, name varchar(255), created_date date not null, base_entity varchar(255) not null, head int8, primary key (id));
