...
create table branch (id int8 not null, name varchar(255) not null, repository int8 not null, linked_to int8, head int8, primary key (id));
...
create table commit_item (id int8 not null, created_date timestamp, root_item_version int8 not null, editor varchar(255), branch int8 not null, primary key (id));
