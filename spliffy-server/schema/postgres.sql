...
create table branch (id int8 not null, name varchar(255) not null, head int8, linked_to int8, repository int8 not null, primary key (id));
create table cal_event (id int8 not null, name varchar(255) not null, description varchar(255), timezone varchar(255), ctag int8 not null, start_date timestamp not null, end_date timestamp not null, summary varchar(255), created_date timestamp not null, modified_date timestamp not null, calendar int8 not null, primary key (id));
create table calendar (id int8 not null, name varchar(255) not null, ctag int8 not null, color varchar(255), created_date timestamp not null, modified_date timestamp not null, owner varchar(255) not null, primary key (id), unique (name, owner));
create table commit_item (id int8 not null, created_date timestamp, editor varchar(255), root_item_version int8 not null, branch int8 not null, primary key (id));
create table contact (id int8 not null, name varchar(255) not null, given_name varchar(255), sur_name varchar(255), mail varchar(255), uid varchar(255) not null, created_date timestamp not null, modified_date timestamp not null, organization_name varchar(255), telephonenumber varchar(255), address_book int8 not null, primary key (id));
create table deleted_item (id int8 not null, deleted_resource int8, deleted_from int8, repo_version int8, primary key (id));
create table directory_member (id int8 not null, name varchar(1000), member_item int8 not null, parent_item int8 not null, primary key (id), unique (name, parent_item));
...
create table item_version (id int8 not null, item_hash int8 not null, modified_date date not null, item int8 not null, primary key (id));
create table permission (id int8 not null, priviledge int4, grantee varchar(255), granted_on int8, primary key (id));
...
create table volume (id int8 not null, used_bytes int8 not null, target_capacity int8 not null, primary key (id));
create table volume_instance (id int8 not null, location varchar(255) not null, capacity int8, cost int4 not null, online bool not null, lost bool not null, instance_type varchar(255) not null, volume int8, primary key (id), unique (location, instance_type));
