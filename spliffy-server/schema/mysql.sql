...
create table branch (id bigint not null auto_increment, name varchar(255) not null, repository bigint not null, linked_to bigint, head bigint, primary key (id));
