...
create table branch (id bigint not null auto_increment, name varchar(255) not null, repository bigint not null, head bigint, linked_to bigint, primary key (id));
