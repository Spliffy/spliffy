...
create table commit_item (id bigint not null auto_increment, created_date datetime, editor varchar(255), branch bigint not null, root_item_version bigint not null, primary key (id));
...
create table deleted_item (id bigint not null auto_increment, repo_version bigint, deleted_resource bigint, deleted_from bigint, primary key (id));
