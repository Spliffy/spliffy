...
create table deleted_item (id bigint not null auto_increment, deleted_from bigint, repo_version bigint, deleted_resource bigint, primary key (id));
create table directory_member (id bigint not null auto_increment, name text, parent_item bigint not null, member_item bigint not null, primary key (id), unique (name, parent_item));
