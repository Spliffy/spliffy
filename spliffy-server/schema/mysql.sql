...
create table branch (id bigint not null auto_increment, name varchar(255) not null, head bigint, repository bigint not null, linked_to bigint, primary key (id));
...
create table deleted_item (id bigint not null auto_increment, repo_version bigint, deleted_from bigint, deleted_resource bigint, primary key (id));
