...
create table branch (id bigint not null auto_increment, name varchar(255) not null, head bigint, linked_to bigint, repository bigint not null, primary key (id));
create table cal_event (id bigint not null auto_increment, name varchar(255) not null, description varchar(255), timezone varchar(255), ctag bigint not null, start_date datetime not null, end_date datetime not null, summary varchar(255), created_date datetime not null, modified_date datetime not null, calendar bigint not null, primary key (id));
create table calendar (id bigint not null auto_increment, name varchar(255) not null, ctag bigint not null, color varchar(255), created_date datetime not null, modified_date datetime not null, owner varchar(255) not null, primary key (id), unique (name, owner));
create table commit_item (id bigint not null auto_increment, created_date datetime, editor varchar(255), root_item_version bigint not null, branch bigint not null, primary key (id));
create table contact (id bigint not null auto_increment, name varchar(255) not null, given_name varchar(255), sur_name varchar(255), mail varchar(255), uid varchar(255) not null, created_date datetime not null, modified_date datetime not null, organization_name varchar(255), telephonenumber varchar(255), address_book bigint not null, primary key (id));
create table deleted_item (id bigint not null auto_increment, deleted_resource bigint, deleted_from bigint, repo_version bigint, primary key (id));
...
create table item_version (id bigint not null auto_increment, item_hash bigint not null, modified_date date not null, item bigint not null, primary key (id));
create table permission (id bigint not null auto_increment, priviledge integer, grantee varchar(255), granted_on bigint, primary key (id));
create table repository (id bigint not null auto_increment, name varchar(255), created_date date not null, head bigint, base_entity varchar(255) not null, primary key (id));
...
create table volume (id bigint not null auto_increment, used_bytes bigint not null, target_capacity bigint not null, primary key (id));
create table volume_instance (id bigint not null auto_increment, location varchar(255) not null, capacity bigint, cost integer not null, online bit not null, lost bit not null, instance_type varchar(255) not null, volume bigint, primary key (id), unique (location, instance_type));
