...
create table branch (id bigint not null auto_increment, name varchar(255) not null, linked_to bigint, head bigint, repository bigint not null, primary key (id));
...
create table commit_item (id bigint not null auto_increment, created_date datetime, branch bigint not null, root_item_version bigint not null, editor varchar(255), primary key (id));
